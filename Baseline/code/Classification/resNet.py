...
# 数据集路径
train_dir = r'g:\NUS\DLCourse\BaseLine\data\dataset\images\train'
val_dir = r'g:\NUS\DLCourse\BaseLine\data\dataset\images\validation'
...
def train_model(model, train_loader, val_loader, epochs=20):
    ...
    #创建保存目录
    save_dir = r'\Baseline\code\Classification\checkpoints\ResNet'
